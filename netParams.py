...
import paramrw
p_exp = paramrw.ExpParams('param/ERPYes100Trials.param')
expmt_group = p_exp.expmt_groups[0]
params = p_exp.return_pdict(expmt_group, 0)

cellRule = netParams.importCellParams(label='L5Pyr_rule', conds={'cellType': 'L5Pyr','cellModel':'HH_reduced'},
                                      fileName='L5_pyramidal.py', cellName='L5Pyr', cellArgs={'p': params})

netParams.renameCellParamsSec('L5Pyr_rule', 'L5Pyr_soma', 'soma')
