...
from PyQt5.QtWidgets import (QMainWindow, QAction, qApp, QApplication,
                             QFileDialog, QComboBox, QToolTip, QPushButton,
                             QGridLayout, QInputDialog, QMenu, QMessageBox,
                             QWidget, QLayout)
...
class HNNGUI(QMainWindow):
    ...
    def __init__(self):
        ...
        self.erselectdistal = \
            EvokedOrRhythmicDialog(self, True, self.baseparamwin.evparamwin,
                                   self.baseparamwin.distparamwin)
        self.erselectprox = \
        ...
        if first_load:
            QMessageBox.information(self, "HNN", "Welcome to HNN! Default"
                                    " parameter file loaded. Press 'Run"
                                    " Simulation' to display simulation"
                                    " output")
        else:
    ...
    def excepthook(self, exc_type, exc_value, exc_tb):
        ...
        msgBox.information(
            self, "Exception", "WARNING: an exception occurred"
    ...
    def changeFontSize(self):
        ...
        i, ok = QInputDialog.getInt(self, "Set Font Size", "Font Size:",
                                    plt.rcParams['font.size'], 1, 100, 1)
        if ok:
    ...
    def changeLineWidth(self):
        ...
        i, ok = QInputDialog.getInt(self, "Set Line Width", "Line Width:",
                                    plt.rcParams['lines.linewidth'], 1, 20, 1)
        if ok:
    ...
    def changeMarkerSize(self):
        ...
        i, ok = QInputDialog.getInt(self, "Set Marker Size", "Font Size:",
                                    self.markersize, 1, 100, 1)
        if ok:
    ...
    def showAboutDialog(self):
        ...
        msgBox.setText("Human Neocortical Neurosolver (HNN) v" + __version__ +
                       "<br>" +
                       "<a href=https://hnn.brown.edu>https://hnn.brown.edu" +
                       "</a><br>" +
                       "<a href=https://github.com/jonescompneurolab/hnn>" +
                       "HNN On Github</a><br>© 2017-2019 "
                       "<a href=http://brown.edu>Brown University" +
                       ", Providence, RI</a><br><a " +
                       "href=https://github.com/jonescompneurolab/hnn/blob" +
                       "/master/LICENSE>Software License</a>")
    ...
    def showoptparamwin(self):
        bringwintotop(self.baseparamwin.optparamwin)

    def showdistparamwin(self):
        bringwintotop(self.erselectdistal)

    def showproxparamwin(self):
        bringwintotop(self.erselectprox)
